...
```bash
python3 xor_killer.py [--hex ... | --multihex ...] [--key ...] [--ror N] [--rol N] [--sub N|index] [--add N|index]
```
...
```bash
python3 xor_killer.py --hex 5a 3f 12 8b --key aa
```
...
```bash
python3 xor_killer.py --multihex 0x1a2b3c4d/4 0x9f/1 0x00ff/2 --key 13
```
...
```bash
python3 xor_killer.py --hex 6a 5d 12 ff --key 37
```
...
```bash
python3 xor_killer.py --hex 6a 5d 12 ff 90 --key 41 42 31 32
```
...
```bash
python3 xor_killer.py --hex 6a 5d 12 ff
...
```bash
python3 xor_killer.py --hex 6a 5d 12 ff --key 37 --ror 3
```

Flip the order if the original obfuscation was applied the other way:

```bash
python3 xor_killer.py --hex 6a 5d 12 ff --ror 3 --key 37
```
...
```bash
python3 xor_killer.py --hex 6a 5d 12 ff --sub index
```
...
```bash
python3 xor_killer.py --hex 6a 5d 12 ff 90 21 --sub index --key de --ror 5
```
...
```bash
python3 xor_killer.py --multihex 0x48656c6c6f2100/7 --key 00
